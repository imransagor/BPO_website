...
<head>
	<title>Natural Multipurpose Flat Bootstrap Responsive Website Template | About :: W3layouts</title>
	<!-- Meta tag Keywords -->
	...
	<div id="home">
		...
		<div class="banner_w3lspvt-2 text-center">
			...
			<div class="banner-inner">
				<h1><a href="index.html" class="logo-2">Natural</a></h1>
			</div>
		</div>
		<!-- //banner -->
	</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-lg-6 about-left-inner">
					<h3>Cras ut diam placerat, placerat justo sed, lacinia risus.</h3>
					<h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ut mollis turpis, sed tincidunt
						purus.</h5>
					<p class="mt-4">Duis nisi sapien, elementum finibus fermentum eget, aliquet leo. Mauris hendrerit
						vel ex.
						Quisque vitae luctus massa. Phasellus sed aliquam leo. Vestibulum ullamcorper a massa eu
						fringilla. Integer ultrices finibus sed nisi.<br>
						In convallis felis dapibus sit amet. Donec a arcu et sapien hendrerit accumsan asased.</p>
				</div>
				<div class="col-lg-6 about-right-inner text-center mt-lg-0 mt-5">
					<img src="images/ab3.jpg" alt="" class="img-fluid img-border" />
				</div>
			</div>
